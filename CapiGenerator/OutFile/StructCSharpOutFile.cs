...
public sealed class StructCSharpOutFile : BaseCSharpOutFile
{
    private readonly Dictionary<string, string> _memberNames = new();

    internal StructCSharpOutFile(string namespaceValue, string path) :
    ...
    internal override Task WriteToDiskAsync()
    {
        ...
        builder.AppendLine($"public partial struct {ClassName}");
